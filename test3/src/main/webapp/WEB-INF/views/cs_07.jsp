...
<html lang="en">
  ...
  <!-------------header------------------------------------------------------------------------------------------------------------------------>
	...
	<section class="ftco-section" style="padding-top:50px; margin-bottom: 50px;">
		<div class="container">
  	...
  	<div id="recentlyProduct" style=" position: absolute; width:120px; height:310px; margin-left:1370px; border:1px solid #d2d2d2; margin-top:-100px; ">
		...
		<table class="table" style="margin-top:20px; text-align:center;">
      		     ...
      		     <thead class="table-dark" align=center> 
      		     	...
      		     	<tr style="height:200px; text-align:left; background-color:white; ">
      		     		<td style="padding-bottom:150px; color:black;">5월 말에 주문 했는데 배송은 언제 되나요?</td>	
      		     	</tr>
      		     	<tr style=" height:30px; ">
      		     		<td>[답변]배송 언제 되나요</td>
      		     		
      		     	</tr>
      		     	<tr style="border-bottom:0.5px solid grey; height:200px; text-align:left; background-color:white; ">
      		     		<td style="padding-bottom:150px; color:black;">홍길동 고객님 안녕하세요. 주문하신 상품은 6/4일 오늘 출고 예정입니다.조금만 기다려주세요^^</td>									
      		     	</tr>
		     	</thead>
      	</table>
      	<button id="buttonmy" type="submit" class="btn btn-dark" style="float:left; margin-left:590px; margin-top:30px;">목록</button>
      	<button id="buttonmy" type="submit" class="btn btn-dark" style="float:left; margin-left:1100px; margin-top:-30px;">수정</button>
      	<button id="buttonmy" type="submit" class="btn btn-dark" style="float:left; margin-left:1190px; margin-top:-30px;">삭제</button>
